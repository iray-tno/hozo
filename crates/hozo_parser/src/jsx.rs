...
fn build_node(
    ...
    for attr_item in &el.opening_element.attributes {
        ...
        match attr_name.name.as_str() {
            ...
            "onStartShouldSetResponder" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_start_should_set_responder, &mut props.passthrough, scope, diagnostics, consumed),
            "onStartShouldSetResponderCapture" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_start_should_set_responder_capture, &mut props.passthrough, scope, diagnostics, consumed),
            "onMoveShouldSetResponder" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_move_should_set_responder, &mut props.passthrough, scope, diagnostics, consumed),
            "onMoveShouldSetResponderCapture" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_move_should_set_responder_capture, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderGrant" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_grant, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderStart" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_start, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderMove" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_move, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderEnd" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_end, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderRelease" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_release, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderReject" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_reject, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderTerminate" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_terminate, &mut props.passthrough, scope, diagnostics, consumed),
            "onResponderTerminationRequest" if matches!(primitive, Primitive::View | Primitive::Pressable | Primitive::TouchableOpacity) => capture_prop_expr(attr, &mut props.on_responder_termination_request, &mut props.passthrough, scope, diagnostics, consumed),
