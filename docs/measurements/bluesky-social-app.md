...
3. **RNW cannot yet be removed:** 1 files retain 1 direct React Native JSX bindings after Web lowering.
...
| filesWithDirectReactNativeJsxResidueOnWeb | 1 |
| directReactNativeJsxBindingsResidueOnWeb | 1 |
