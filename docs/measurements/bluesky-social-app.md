...
3. **RNW cannot yet be removed:** 3 files retain 3 direct React Native JSX bindings after Web lowering.
...
|---|---:|
| filesLowered | 574 |
| filesLoweredForWeb | 568 |
| filesLoweredForNative | 544 |
| webComponents | 1224 |
| nativeComponents | 1179 |
| directReactNativeJsxPassedThroughOnWeb | 0 |
| filesWithDirectReactNativeJsxResidueOnWeb | 3 |
| directReactNativeJsxBindingsResidueOnWeb | 3 |
