...
全 CSS 名で 451/522 (86.4%)、両 platform に名前が存在するか、同じ typed IR へ
正確に展開できる集合で 134/134 (100%)、contextual runtime 集合で 21/21
(100%)、Web-only 集合で 296/366 (80.9%)。残りは optional adapter 候補 1、
...
現在の実行可能scorecardでは、代表value 288/288 (100%)、一般的なauthoring
construct 16/16 (100%)、Card/Typography/Input/Scroll/Motion/Grid/Borderへ利用頻度を
持たせた宣言249/249 (100%)、silent failure 0となった。valueはHozo Webが公式
