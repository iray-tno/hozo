...
public class SpeechLogService extends TextToSpeechService {
    ...
    protected void onSynthesizeText(SynthesisRequest request, SynthesisCallback callback) {
        ...
        //
        // Prefixed with the UID that asked for it, because TalkBack is not the
        // only thing on the device that speaks through the default engine. One
        // run had Android's own "Service, Messages is restoring backed up
        // message content and data" arrive mid-walk, credited to a step and
        // counted towards the total that is supposed to mean TalkBack read the
        // screen (#470). No wording tells that apart from something the app
        // under test said; the caller does.
        Log.i(
                TAG,
