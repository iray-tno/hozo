...
function TextInputGallery() {
  ...
  return (
    <View className="max-w-md space-y-6 rounded-2xl bg-white p-8 shadow-sm">
      ...
      <View className="space-y-4">
        <View className="space-y-1.5">
          ...
          <TextInput
            ...
            className="w-full rounded-lg border border-slate-300 px-3.5 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
        ...
        <View className="space-y-1.5">
          ...
          <TextInput
            ...
            className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2 text-sm text-slate-400 cursor-not-allowed"
