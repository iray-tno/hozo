...
const coreApiOwnership = {
  Pressable: [
    'P0',
    'Runtime component identity remains in component props and animation wrappers.',
  ],
  ...
  TextInput: ['P0', 'Runtime component identity remains in an app-owned input factory.'],
}
