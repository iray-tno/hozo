...
export const STYLEX_VALUE_CASES: readonly StylexValueCase[] = [
  ...
  { property: 'boxAlign', value: 'center' },
  { property: 'boxDirection', value: 'reverse' },
  { property: 'boxFlex', value: 1 },
  { property: 'boxFlexGroup', value: 2 },
  { property: 'boxLines', value: 'multiple' },
  { property: 'boxOrdinalGroup', value: 2 },
  { property: 'boxOrient', value: 'vertical' },
  { property: 'boxSuppress', value: 'discard' },
  ...
  { property: 'maskBorder', value: 'url(mask.svg) 30 round alpha' },
  { property: 'borderImage', value: 'url(border.svg) 30 round' },
  { property: 'cornerShape', value: 'squircle' },
  { property: 'cornerStartStartShape', value: 'scoop' },
  { property: 'cornerStartEndShape', value: 'bevel' },
  { property: 'cornerEndStartShape', value: 'notch' },
  { property: 'cornerEndEndShape', value: 'square' },
  { property: 'cornerTopLeftShape', value: 'round' },
  { property: 'cornerTopRightShape', value: 'scoop' },
  { property: 'cornerBottomLeftShape', value: 'bevel' },
  { property: 'cornerBottomRightShape', value: 'notch' },
  { property: 'positionArea', value: 'top' },
  { property: 'positionTryFallbacks', value: 'flip-block, --menu-below' },
  { property: 'positionTryOptions', value: 'flip-inline' },
  { property: 'positionTry', value: 'most-width flip-block, --menu-below' },
  { property: 'glyphOrientationVertical', value: 'auto' },
  { property: 'kerning', value: '0.1em' },
  { property: 'textDecorationSkip', value: 'objects ink' },
  { property: 'counterIncrement', value: 'chapter 1 section' },
  { property: 'counterReset', value: 'chapter 0 section 1' },
  { property: 'counterSet', value: 'chapter 3' },
  ...
  { property: 'outline', value: '2px solid #123456' },
  ...
  { property: 'motion', value: 'path("M 0 0 L 100 100")' },
  { property: 'motionOffset', value: '25%' },
  { property: 'motionPath', value: 'path("M 0 0 L 100 100")' },
  { property: 'motionRotation', value: 'auto 45deg' },
  { property: 'cue', value: 'url(chime.wav)' },
  { property: 'cueAfter', value: 'none' },
  { property: 'cueBefore', value: 'url(chime.wav)' },
  { property: 'pause', value: 'medium' },
  { property: 'pauseAfter', value: 200 },
  { property: 'pauseBefore', value: 'strong' },
  { property: 'rest', value: 'weak' },
  { property: 'restAfter', value: 300 },
  { property: 'restBefore', value: 'none' },
  { property: 'azimuth', value: 'center-right' },
  { property: 'speak', value: 'normal' },
  { property: 'speakAs', value: 'spell-out' },
  { property: 'voiceBalance', value: 'left' },
  { property: 'voiceDuration', value: '500ms' },
  { property: 'voiceFamily', value: 'male' },
  { property: 'voicePitch', value: 'medium' },
  { property: 'voiceRange', value: 'medium' },
  { property: 'voiceRate', value: 'fast' },
  { property: 'voiceStress', value: 'strong' },
  { property: 'voiceVolume', value: 'medium' },
  { property: 'azimuth', value: '20deg' },
  { property: 'voiceBalance', value: '25%' },
  { property: 'voiceFamily', value: 'Alex' },
  { property: 'voicePitch', value: '220Hz' },
  ...
  { property: 'imageResolution', value: '2dppx snap' },
  { property: 'initialLetter', value: '3 2' },
  { property: 'marginTrim', value: 'block' },
  { property: 'scrollTimelineName', value: '--page-scroll' },
  { property: 'timelineScope', value: '--page-scroll, --card-view' },
  { property: 'viewTransitionName', value: 'hero-card' },
  { property: 'anchorName', value: '--tooltip-anchor' },
