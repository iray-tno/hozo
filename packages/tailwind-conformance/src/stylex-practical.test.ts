...
test('speech cue and pause controls agree with the CSS emitted by official StyleX', () => {
...
test('speech voice controls agree with the CSS emitted by official StyleX', () => {
  const properties = new Set([
    'azimuth',
    'speak',
    'speakAs',
...
test('named page selection agrees with the CSS emitted by official StyleX', () => {
  const testCase = { property: 'page', value: 'chapter' }
  assert.deepEqual(compareStylexValue(testCase), {
    ...testCase,
    covered: true,
    silent: false,
