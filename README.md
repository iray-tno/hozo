...
Against StyleX 0.19.0's published types that is **271/522 property names
(51.9%)**, including **116/116 (100%)** when the denominator is restricted to
names React Native also publishes and **16/16 (100%)** contextual-runtime
names. Web-only lowering is reported independently at **139/389 (35.7%)**. The
...
corpus currently measures **136/136 (100%)** representative values, **14/14
...
resolved; ambiguous or wider values remain residual.
